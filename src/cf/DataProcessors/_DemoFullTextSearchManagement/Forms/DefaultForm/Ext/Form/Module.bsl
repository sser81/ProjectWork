...
Procedure ClearIndex(Command)
	ExecuteCommandInBackground("ClearIndex", NStr("en = 'Clear full-text search index';"));
EndProcedure

&AtClient
Procedure UpdateIndex(Command)
	ExecuteCommandInBackground("UpdateIndex", NStr("en = 'Update full-text search index';"));
EndProcedure
